      ...
      >
        ...
        <View style={s.card}>
          ...
          <View style={s.nameRow}>
            <InputField
              icon="person" placeholder="First name" value={firstName}
          ...
          <InputField
            icon="lock-outline" placeholder="Confirm password" value={confirm}
          ...
          <PrimaryButton
            label="Create Account" onPress={handleSignup}
